define(["exports", "./helper/math.js"], function (_exports, _math) {
  "use strict";
  ...
  class IndicatorTable extends Uint32Array {
    processTimetable(time_table, max_cache_hit_number) {
      ...
      const mean_time = (0, _math.mean)(time_table); // console.log(`%cmean ${mean_time | 0}`, "font-size: 1em");
      ...
      if (mean_time > 0) {
        ...
        --selector_threshold; // unique threshold variant
  ...
  _exports.default = IndicatorTable;
});