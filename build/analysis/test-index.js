define(["exports", "../helper/math.js", "./alloc-reload-probe.js", "../indicator-table.js"], function (_exports, _math, _allocReloadProbe, _indicatorTable) {
  "use strict";
  ...
  _allocReloadProbe = _interopRequireDefault(_allocReloadProbe);
  _indicatorTable = _interopRequireDefault(_indicatorTable);

  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

  var _default = (async () => {
    const allocReloadProbe = await _allocReloadProbe.default;
    return async function testIndex(probe_index, min_iterations, max_cache_hit_number, page_size, probe_length) {
      ...
      const mean_times = []; // console.log("probe_index", probe_index);
      ...
      for (; i < min_iterations; ++total_iterations) {
        ...
        const time_table = allocReloadProbe(probe_index, page_size, probe_length); // for (let i = 0; i < 1e8; ++i);
