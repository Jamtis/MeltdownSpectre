...
function check(num, data_array)
{
    ...
    // const worker = new Worker('../spectre-master/worker.js');
    ...
    // worker.onmessage = function(msg)
    {
        ...
        for(var i=0;i<data_array.length;i++)
        {
            ...
            {
                // document.body.insertAdjacentHTML("afterbegin", "no data match<br>");
                ...
                if((num*2) <= 128)
                {
                    ...
                    // document.body.insertAdjacentHTML("afterbegin", num*2+" cache<br>");
                    console.log(num * 2 + " cache");
                    check(num*2, data_array);
                }
                else
                {
                    // parent.postMessage([0, i], "*");
                    console.log([0, i], "*");
                ...
                // document.body.insertAdjacentHTML("afterbegin", "data match<br>");
            }
        }

        // worker.terminate();
        // parent.postMessage([1,num], "*");
        console.log([1,num], "*");
        // output_info_leak();
        return;
    }
